    ...
    <article className="zscore-card">
      ...
      <div className="zscore-card__chartShell">
        ...
        >
          ...
          <path d={chart.upperBandPath} className="zscore-chart__band zscore-chart__band--upper" />
          <path d={chart.middleBandPath} className="zscore-chart__band zscore-chart__band--middle" />
          <path d={chart.lowerBandPath} className="zscore-chart__band zscore-chart__band--lower" />
