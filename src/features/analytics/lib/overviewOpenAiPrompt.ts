...
export function buildOverviewQualitativeOpenAiPrompt(snapshot: AnalyticsSymbolFeed) {
  ...
  return [
    ...
    '',
    'Quiero una respuesta breve en espanol usando solo estas tres secciones:',
    ...
    '- Debajo de las dos tablas debe haber solo una conclusion global, en un unico parrafo corto de maximo 4 oraciones.',
