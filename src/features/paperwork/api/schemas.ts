...
export const parsedInvoiceLookupRecordSchema = z.object({
  ...
  payable_amount: nullableNumberLikeSchema.optional(),
  tax_exclusive_amount: nullableNumberLikeSchema.optional(),
  tax_inclusive_amount: nullableNumberLikeSchema.optional(),
  tax_amount: nullableNumberLikeSchema.optional(),
